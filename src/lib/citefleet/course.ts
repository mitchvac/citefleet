  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Developers mint a bc_live_ key at botcentral.org/keys; every job run is $1.00. Each Top up button on BotCentral opens citefleet.app/topup with that key prefix, and Top up in the nav opens the same page. The customer opens an invoice there and pays the quoted amount; an operator confirms receipt on the same page with the transaction hash, and BotCentral credits the prefix. Nothing on this page moves money by itself.",
      },
    ],
  },
  {
