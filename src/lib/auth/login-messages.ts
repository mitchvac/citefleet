 ...
 * the generic line (seen 2026-09-03: `email-unverified` rendered "Sign-in
 * failed." on citefleet.app).
 */
export const LOGIN_MESSAGES: Record<string, string> = {
  ...
  // address so registered accounts cannot be enumerated through it.
  "mail-unavailable":
    "This server cannot send email right now, so the reset link was not sent. Tell the CiteFleet operator.",
  "reset-expired": "That reset link has expired. Request a new one — links last 30 minutes.",
  "reset-used":
    "That reset link was already used. Request a new one if you still need to change your password.",
  "reset-not-found": "That reset link is not valid. Request a new one.",
  "reset-weak-password": "Pick a password of at least 8 characters.",
