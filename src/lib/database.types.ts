...
export type Database = {
  public: {
    Tables: {
      ...
      citefleet_vercel_origin_installs: {
        Row: {
          consumed_at: string | null;
          created_at: string;
          expires_at: string;
        ...
        Relationships: [
          {
            foreignKeyName: "citefleet_vercel_origin_installs_user_id_fkey";
            columns: ["user_id"];
            isOneToOne: false;
            referencedRelation: "citefleet_users";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "citefleet_vercel_origin_installs_workspace_id_fkey";
            columns: ["workspace_id"];
            isOneToOne: false;
            referencedRelation: "citefleet_workspaces";
            referencedColumns: ["id"];
