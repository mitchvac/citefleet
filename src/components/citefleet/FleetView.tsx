...
export function FleetView() {
  ...
  if (fleet.loading) return <p className="text-[#9b95b3]">Loading fleet…</p>;
  if (!fleet.store) {
  ...
  return (
    <div className="space-y-4">
      {/* A refused Run (kill switch / frozen door) must be visible here, like on Command and the campaign board. */}
      {fleet.error && (
